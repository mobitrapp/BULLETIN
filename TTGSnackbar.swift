...
public class TTGSnackbar: UIView {
    ...
    */
    private func configure() {
        ...
        actionButton.addTarget(self, action: "doAction:", forControlEvents: .TouchUpInside)
        ...
        secondActionButton.addTarget(self, action: "doAction:", forControlEvents: .TouchUpInside)
    ...
    */
    private func dismissAnimated(animated: Bool) {
        ...
        if let frame = superview?.frame {
            superViewWidth = CGRectGetWidth(frame)
        }
        if !animated {
